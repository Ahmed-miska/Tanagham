...
import 'package:tanagham/features/admin_sup_supporting/admin_sup_supporting_screen.dart';
...
class AdminSupportingSecondListItem extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(color: AppColors.whiteColor, borderRadius: BorderRadius.circular(5), boxShadow: [
        ...
        children: [
          ...
          Expanded(
            ...
            child: Column(
              children: [
                Text(
                  'Mansour Al-Balawi',
                  style: AppTextStyles.styleLight15Almarai.copyWith(color: const Color(0xFF57616C), fontSize: 12.sp),
                  maxLines: 1,
                ),
                Text(
                  'mansour@gmail.com',
                  style: AppTextStyles.styleLight15Almarai.copyWith(color: const Color(0xFF57616C), fontSize: 8.sp),
                  maxLines: 1,
                ),
              ],
            ),
          ...
          Container(
            ...
            child: GestureDetector(
                onTap: () {
                  push(const AdminSupSupportingScreen());
                },
