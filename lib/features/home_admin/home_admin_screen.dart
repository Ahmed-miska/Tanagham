        ...
        children: [
          Positioned(
            ...
            child: CustomBackgroundCircleContainer(
              color: AppColors.splashColor.withOpacity(.1),
              height: 778.h,
              width: 778.h,
              radius: 778.r,
            ),
          ...
          Positioned(
            ...
            right: -110.w,
            child: CustomBackgroundCircleContainer(
              color: AppColors.mainColorTextLight.withOpacity(.1),
              height: 267.h,
              width: 267.h,
              radius: 267.r,
            ),
                  ...
                  child: SingleChildScrollView(
                    child: Column(
                      ...
                      children: [
                        ...
                        verticalSpace(16),
                        Text('Dashboard', style: AppTextStyles.styleRegular17PacificoMainColorTextLight),
                        //const SizedBox(height: 16),
                        verticalSpace(16),
                        ...
                        Row(
                          children: [
                            Text('New Users', style: AppTextStyles.styleRegular17PacificoMainColorTextLight.copyWith(color: AppColors.blackColor)),
                            const Spacer(),
                            Text('See all', style: AppTextStyles.styleLight15Almarai),
                          ],
                        ),
                        //const SizedBox(height: 16),
                        verticalSpace(16),
                        ...
                        Row(
                          children: [
                            Text('Waiting Zone', style: AppTextStyles.styleRegular17PacificoMainColorTextLight.copyWith(color: AppColors.blackColor)),
                            const Spacer(),
                            Text('See all', style: AppTextStyles.styleLight15Almarai),
                          ],
                        ),
